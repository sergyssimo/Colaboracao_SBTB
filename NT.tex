...
\addcontentsline{toc}{subsection}{5.26}
\begin{quote}
 \small
...
\subsection*{Mt 5.31:}
\addcontentsline{toc}{subsection}{5.31}
\begin{quote}
 \small
...
\subsection*{Mt 6.13:}
\addcontentsline{toc}{subsection}{6.13}
\begin{quote}
 \small
...
\subsection*{Mt 10.29:}
\addcontentsline{toc}{subsection}{10.29}
\begin{quote}
 \small
...
\subsection*{Mt 11.10:}
\addcontentsline{toc}{subsection}{11.10}
...
\subsection*{Mt 12.42:}
\addcontentsline{toc}{subsection}{12.42}
\begin{quote}
\small
A \uwave{rainha do meio-dia} se levantará no dia do juízo com esta geração, e a condenará; porque veio dos confins da terra para ouvir a sabedoria de Salomão. E eis que está aqui quem é maior do que Salomão.
\end{quote}
...
\addcontentsline{toc}{subsection}{15.30-31}
\begin{quote}
\small
...
\subsection*{Mt 15.34:}
\addcontentsline{toc}{subsection}{15.34}
\begin{quote}
 \small
...
\addcontentsline{toc}{subsection}{18.28}
\begin{quote}
 \small
...
\subsection*{Mt 20.2:}
\addcontentsline{toc}{subsection}{20.2}
...
\addcontentsline{toc}{subsection}{20.9,10,13}
\begin{quote}
 \small
...
\subsection*{Mt 23.7:}
\addcontentsline{toc}{subsection}{23.7}
\begin{quote}
 \small
...
\subsection*{Mt 24.15:}
\addcontentsline{toc}{subsection}{24.15}
\begin{quote}
 \small
...
\addcontentsline{toc}{subsection}{27.11}
\begin{quote}
 \small
...
\subsection*{Mt 27.54:}
\addcontentsline{toc}{subsection}{27.54}
\begin{quote}
 \small
...
\subsection*{Mc 4.38:}
\addcontentsline{toc}{subsection}{4.38}
\begin{quote}
 \small
...
\addcontentsline{toc}{subsection}{5.25-27}
\begin{quote}
    \small
...
\subsection*{Mc 6.37:}
\addcontentsline{toc}{subsection}{6.37}
\begin{quote}
    \small
Ele, porém, respondendo, lhes disse: Dai-lhes vós de  comer. E eles disseram-lhe: Iremos nós, e compraremos duzentos \uwave{dinheiros} de pão para lhes darmos de comer?
\end{quote}
Ver \ref{denario}.
...
\addcontentsline{toc}{subsection}{11.19}
\begin{quote}
    \small
...
\subsection*{Mc 12.14:}
\addcontentsline{toc}{subsection}{12.14}
\begin{quote}
    \small
E, chegando eles, disseram-lhe:  Mestre, sabemos que és homem de verdade, \uwave{e de ninguém se te  dá}, porque não olhas à aparência dos homens, antes com verdade
...
\begin{quote}
    \small
Vindo, porém, uma pobre viúva, deitou \uwave{duas pequenas moedas}, que valiam meio \uwave{centavo}.
\end{quote}
...
\subsection*{Mc 14.5:}
\addcontentsline{toc}{subsection}{14.5}
\begin{quote}
    \small
...
\subsection*{Mc 14.68:}
\addcontentsline{toc}{subsection}{14.68}
\begin{quote}
    \small
Mas ele negou-o, dizendo: Não o conheço, nem sei o que dizes. E \uwave{saiu fora} ao alpendre, e o galo cantou.
    \end{quote}
...
\begin{quote}
    \small
E aconteceu que, no \uwave{sábado segundo-primeiro}, passou pelas searas, e os seus discípulos iam arrancando espigas e, esfregando-as com as mãos, as comiam.
\end{quote}
...
\subsection*{Lc 10.35:}
\addcontentsline{toc}{subsection}{10.35}
\begin{quote}
    \small
...
\subsection*{Lc 12.6a:}
\addcontentsline{toc}{subsection}{12.6a}
\begin{quote}
    \small
...
\subsection*{Lc 12.59:}
\addcontentsline{toc}{subsection}{12.59}
\begin{quote}
    \small
...
\subsection*{Lc 14.10:}
\addcontentsline{toc}{subsection}{14.10}
\begin{quote}
    \small
...
\subsection*{Lc 14.26:}
\addcontentsline{toc}{subsection}{14.26}

\begin{quote}
    \small
Se alguém vier a mim, e não \uwave{aborrecer} a seu pai, e mãe, e mulher, e filhos, e irmãos, e irmãs, e ainda também a sua própria vida, não pode ser meu discípulo.
\end{quote}
...
\subsection*{Lc 15.5:}
\addcontentsline{toc}{subsection}{15.5}
\begin{quote}
    \small
...
\subsection*{Lc 22.62:}
\addcontentsline{toc}{subsection}{22.62}
\begin{quote}
    \small
...
\begin{quote}
    \small
Filipe respondeu-lhe: Duzentos \uwave{dinheiros} de pão não lhes bastarão, para que cada um deles tome um pouco.
\end{quote}

Ver item \ref{denario}.

\subsection*{Jo 6.17:}
\addcontentsline{toc}{subsection}{6.17}
\begin{quote}
    \small
...
\addcontentsline{toc}{subsection}{6.22-24}
\begin{quote}
    \small
...
\subsection*{Jo 11.28:}
\addcontentsline{toc}{subsection}{11.28}
\begin{quote}
    \small
...
\subsection*{Jo 11.38:}
\addcontentsline{toc}{subsection}{11.38}
\begin{quote}
    \small
...
\subsection*{Jo 11.43:}
\addcontentsline{toc}{subsection}{11.43}
\begin{quote}
    \small
...
\subsection*{Jo 12.5:}
\addcontentsline{toc}{subsection}{12.5}
\begin{quote}
    \small
...
\subsection*{Jo 18.29:}
\addcontentsline{toc}{subsection}{18.29}
\begin{quote}
    \small
Então Pilatos \uwave{saiu fora} e disse-lhes: Que acusação trazeis contra este homem?
\end{quote}

Sem comentários (cf.~item \ref{saiu}).

\subsection*{Jo 19.4,5:}
\addcontentsline{toc}{subsection}{19.4-5}
\begin{quote}
    \small
...
\subsection*{At 4.36:}
\addcontentsline{toc}{subsection}{4.36}
\begin{quote}
    \small
...
\subsection*{At 9.40:}
\addcontentsline{toc}{subsection}{9.40}
\begin{quote}
    \small
...
\subsection*{At 16.13:}
\addcontentsline{toc}{subsection}{16.13}
\begin{quote}
    \small
...
\subsection*{At 23.24:}
\addcontentsline{toc}{subsection}{23.24}
\begin{quote}
    \small
...
\subsection*{At 26.30:}
\addcontentsline{toc}{subsection}{26.30}
\begin{quote}
    \small
...
\section{Romanos}
\subsection*{Rm 5.12:}
\addcontentsline{toc}{subsection}{5.12}
\begin{quote}
    \small
Portanto, como por um homem entrou o pecado no mundo, e  pelo pecado a morte, assim também a morte passou a todos os \uwave{homens por isso} que todos pecaram.
\end{quote}
...
\section{I Coríntios}
\subsection*{1Co 5.13:}
\addcontentsline{toc}{subsection}{5.13}
\begin{quote}
    \small
...
\addcontentsline{toc}{subsection}{3.17}
\begin{quote}
    \small
...
\addcontentsline{toc}{subsection}{1.13-14}
\begin{quote}
    \small
...
\section{Filipenses}
\subsection*{Fp 3.5-6:}
\addcontentsline{toc}{subsection}{3.5-6}
\begin{quote}
    \small
...
\addcontentsline{toc}{subsection}{2.11-12}
\begin{quote}
    \small
E por isso Deus lhes enviará a operação do erro, para que \uwave{creiam a mentira}; para que sejam julgados todos os que não \uwave{creram a verdade}, antes tiveram prazer na iniqüidade.
\end{quote}
...
\begin{quote}
    \small
A Timóte\uwave{o m}eu verdadeiro filho na fé: Graça, misericórdia e paz da parte de Deus nosso Pai, e da de Cristo Jesus, nosso Senhor.
\end{quote}
...
\section{Filemom}
\subsection*{Fm 10-16:}
\addcontentsline{toc}{subsection}{10-16}
\begin{quote}
    \small
...
\section{Hebreus}
\subsection*{Hb 3.7-9:}
\addcontentsline{toc}{subsection}{3.7-9}
\begin{quote}
    \small
...
\addcontentsline{toc}{subsection}{5.10}
\begin{quote}
    \small
...
\subsection*{Ap 6.5:}
\addcontentsline{toc}{subsection}{6.5}
\begin{quote}
    \small
...
\subsection*{Ap 6.6:}
\addcontentsline{toc}{subsection}{6.6}
\begin{quote}
    \small
...
\subsection*{Ap 22.12:}
\addcontentsline{toc}{subsection}{22.12}
\begin{quote}
    \small
