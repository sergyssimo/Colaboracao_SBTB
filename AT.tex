...
\subsection*{Is 5.25:} 
 \addcontentsline{toc}{subsection}{5.25}
 \begin{quote}
  \small
...
\textbf{RA}: Mas, se ainda ficar a décima parte dela, tornará a ser destruída. Como terebinto e como carvalho, dos quais, depois de derribados, ainda fica o toco, assim a santa semente é o seu toco.
...
\subsection*{Is 7.9:} 
 \addcontentsline{toc}{subsection}{7.9}
 \begin{quote}
  \small
...
\subsection*{Is 7.23:} 
 \addcontentsline{toc}{subsection}{7.23}
 \begin{quote}
  \small
...
\textbf{KJ}: And it shall come to pass in that day, that every place shall be, where there were a thousand vines at a thousand silverlings, it shall even be for briers and thorns.

\subsection*{Is 14.12:} 
 \addcontentsline{toc}{subsection}{14.12}
 \begin{quote}
 \small
...
\subsection*{Is 19.22-23:} 
 \addcontentsline{toc}{subsection}{19.22-23}
 \begin{quote}
  \small
...
\subsection*{Is 35.8:} 
 \addcontentsline{toc}{subsection}{35.8}
 \begin{quote}
  \small
...
\subsection*{Is 36.12:} 
 \addcontentsline{toc}{subsection}{36.12}
 \begin{quote}
  \small
...
\subsection*{Is 37.9:} 
 \addcontentsline{toc}{subsection}{37.9}
 \begin{quote}
  \small
...
\subsection*{Is 38.3:} 
 \addcontentsline{toc}{subsection}{38.3}
 \begin{quote}
  \small
...
\subsection*{Is 38.14:} 
 \addcontentsline{toc}{subsection}{38.14}
 \begin{quote}
  \small
...
\textbf{RC}: Como o grou ou a andorinha, assim eu chilreava e gemia como a pomba; alçava os olhos ao alto; ó Senhor, ando oprimido! Fica por meu fiador.
...
\subsection*{Is 40.20:} 
 \addcontentsline{toc}{subsection}{40.20}
 \begin{quote}
  \small
...
\subsection*{Jr 1.9-10:} 
 \addcontentsline{toc}{subsection}{1.9-10}
 \begin{quote}
  \small
...
\textbf{RA}: Depois, estendeu o SENHOR a mão, tocou-me na boca e o SENHOR me disse: Eis que ponho na tua boca as minhas palavras. Olha que hoje te constituo sobre as nações e sobre os reinos, para arrancares e derribares, para destruíres e arruinares e também para edificares e para plantares.
...
\subsection*{Jr 7.12:} 
 \addcontentsline{toc}{subsection}{7.12}
 \begin{quote}
  \small
...
\subsection*{Jr 13.27:} 
 \addcontentsline{toc}{subsection}{13.27}
 \begin{quote}
  \small
...
\textbf{RA}: Tenho visto as tuas abominações sobre os outeiros e no campo, a saber, os teus adultérios, os teus rinchos e a luxúria da tua prostituição. Ai de ti, Jerusalém! Até quando ainda não te purificarás?
...
\subsection*{Jr 15.14-15:} 
 \addcontentsline{toc}{subsection}{15.14-15}
 \begin{quote}
  \small
...
\subsection*{Jr 18.3-4:} 
 \addcontentsline{toc}{subsection}{18.3-4}
 \begin{quote}
  \small
...
\subsection*{Jr 20.1:} 
 \addcontentsline{toc}{subsection}{20.1}
 \begin{quote}
  \small
...
\subsection*{Jr 26.19:} 
 \addcontentsline{toc}{subsection}{26.19}
 \begin{quote}
  \small
...
\textbf{RA}: Mataram-no, acaso, Ezequias, rei de Judá, e todo o Judá? Antes, não temeu este ao SENHOR, não implorou o favor do SENHOR? E o SENHOR não se arrependeu do mal que falara contra eles? E traríamos nós tão grande mal sobre a nossa alma?
...
\subsection*{Jr 27.4:} 
 \addcontentsline{toc}{subsection}{27.4}
 \begin{quote}
  \small
...
\subsection*{Jr 27.8-9:} 
 \addcontentsline{toc}{subsection}{27.8-9}
 \begin{quote}
  \small
...
Ponto depois de ``até que a consuma pela sua mão;''\ldots
...
\subsection*{Jr 29.23:} 
 \addcontentsline{toc}{subsection}{29.23}
 \begin{quote}
  \small
...
\subsection*{Jr 47.6:} 
 \addcontentsline{toc}{subsection}{47.6}
 \begin{quote}
  \small
...
\subsection*{Jr 48.3:} 
 \addcontentsline{toc}{subsection}{48.3}
 \begin{quote}
  \small
...
\subsection*{Jr 50.25:} 
 \addcontentsline{toc}{subsection}{50.25}
 \begin{quote}
  \small
...
\subsection*{Jr 50.27:} 
 \addcontentsline{toc}{subsection}{50.27}
 \begin{quote}
  \small
...
\subsection*{Jr 51.16-17:} 
 \addcontentsline{toc}{subsection}{51.16-17}
 \begin{quote}
  \small
...
\subsection*{Jr 52.4:} 
 \addcontentsline{toc}{subsection}{52.4}
 \begin{quote}
  \small
...
\subsection*{Lm 1.9,11:} 
 \addcontentsline{toc}{subsection}{1.9,11}
 \begin{quote} 
  \small
...
\subsection*{Dn 4.18:} 
 \addcontentsline{toc}{subsection}{4.18}
 \begin{quote}
  \small
...
\section{Zacarias}
\subsection*{Zc 9.9:} 
\addcontentsline{toc}{subsection}{9.9}
\begin{quote}
  \small
